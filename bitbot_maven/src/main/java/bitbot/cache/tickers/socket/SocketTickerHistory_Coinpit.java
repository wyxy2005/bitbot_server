 ...
 * @author zheng
 */
public class SocketTickerHistory_Coinpit extends IoHandlerAdapter implements TickerHistoryInterface {
    ...
    public SocketTickerHistory_Coinpit(boolean enableTrackTrades, String ExchangeSite, String CurrencyPair) {
