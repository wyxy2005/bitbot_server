...
public class Notification {
     ...
     * notifications you have to set the X-WNS header and ContentType after
     * creating this notification or use createWindowsRawNotification method
     *
     * @param body
     * @return
     */
    ...
    /**
     * Utility method to set up a native notification for APNs. An expiry Date
     * of 1 day is set by default.
     *
     * @param body
     * @return
     */
    ...
    /**
     * Utility method to set up a native notification for APNs. Enables to set
     * the expiry date of the notification for the APNs QoS.
     *
     * @param body
     * @param expiry - the expiration date of this notification. a null value
     * will be interpreted as 0 seconds.
     * @return
     */
