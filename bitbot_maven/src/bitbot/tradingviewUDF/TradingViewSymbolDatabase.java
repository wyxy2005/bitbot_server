...
public class TradingViewSymbolDatabase {
    ...
    static {        
        ...
        SYMBOLS.add(new TradingViewSymbol("BFX_USD", "Bitfinex/ Dollar", "Bitfinex", "bitcoin"));
        SYMBOLS.add(new TradingViewSymbol("BFX_BTC", "Bitfinex/ Bitcoin", "Bitfinex", "bitcoin"));
        SYMBOLS.add(new TradingViewSymbol("ZEC_USD", "Zerocoin/ Dollar", "Bitfinex", "bitcoin"));
        SYMBOLS.add(new TradingViewSymbol("ZEC_BTC", "Zerocoin/ Bitcoin", "Bitfinex", "bitcoin"));
        SYMBOLS.add(new TradingViewSymbol("RRT_USD", "Recovery Right Tokens/ Dollar", "Bitfinex", "bitcoin"));
        SYMBOLS.add(new TradingViewSymbol("RRT_BTC", "Recovery Right Tokens/ Bitcoin", "Bitfinex", "bitcoin"));
