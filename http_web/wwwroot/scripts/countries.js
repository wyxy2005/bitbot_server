...
function populateStates( countryElementId, stateElementId ){
	...
	for (var i=0; i<state_arr.length; i++) {
	    stateElement.options[stateElement.length] = new Option(state_arr[i].toUpperCase(),state_arr[i].toUpperCase());
	}
}
...
function populateCountries(countryElementId, stateElementId){
	...
	for (var i=0; i<country_arr.length; i++) {
	    countryElement.options[countryElement.length] = new Option(country_arr[i].toUpperCase(),country_arr[i].toUpperCase());
	}
