...
//    private final static byte key[] = {0x13, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, (byte) 0xB4, 0x00, 0x00, 0x00, 0x1B, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x33, 0x00, 0x00, 0x00, 0x52, 0x00, 0x00, 0x00};
    // KMS
//    private final static byte key[] = {0x13, 0x00, 0x00, 0x00, 0x52, 0x00, 0x00, 0x00, 0x2A, 0x00, 0x00, 0x00, 0x5B, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00};
    private byte iv[];
    private Cipher cipher;
    private short version;

    /**
     * Class constructor - Creates an instance of the encryption
     * cipher.
     *
     * @param key The 256 bit AES key to use.
     * @param iv The 4-byte IV to use.
     */
    public AESOFB(byte iv[], short version) {
	final byte[] key = new byte[]{0x13, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, (byte) 0xB4, 0x00, 0x00, 0x00, 0x1B, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0x00, 0x33, 0x00, 0x00, 0x00, 0x52, 0x00, 0x00, 0x00};
	...
	this.setIv(iv);
	this.version = (short) (((this.version >> 8) & 0xFF) | ((this.version << 8) & 0xFF00));
    }
     ...
     */
    public byte[] crypt(byte[] data) { // False = Localhost.
    ...
    public byte[] getPacketHeaderEx(final int length) {
	int iiv = (iv[3]) & 0xFF;
	iiv |= (iv[2] << 8) & 0xFF00;
	...
	return ((((packet[0] ^ iv[2]) & 0xFF) == ((version >> 8) & 0xFF)) && (((packet[1] ^ iv[3]) & 0xFF) == (version & 0xFF)));
    }
