...
set CLASSPATH=.;dist/BitBot.jar;../dist/ta-lib.jar;../dist/mina-core-2.0.9.jar;../dist/slf4j-api-1.7.7.jar;../dist/slf4j-jdk14-1.7.7.jar;../dist/slf4j-api-1.7.7.jar;../dist/simple-xml-2.7.1.jar;../dist/simple-5.1.5.jar;../dist/json-simple-1.1.1.jar;../dist/commons-codec-1.6.jar;../dist/sqljdbc42.jar"
