...
/usr/java/jdk1.8.0/bin/java -server -Djsse.enableCBCProtection=false -XX:ThreadStackSize=256k -XX:+UseParallelGC -XX:+TieredCompilation -XX:+HeapDumpOnOutOfMemoryError -Xms10m -Xmx14000m -Djava.library.path=sqljdbc_4.0/enu/auth/x64 \
bitbot.Main start